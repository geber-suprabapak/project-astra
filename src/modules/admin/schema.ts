...
export const bootstrapSchoolSchema = z.object({
  ...
  slug: z
    ...
    .regex(
      /^[a-z0-9-_]+$/,
      'School slug must contain only lowercase letters, numbers, hyphens, and underscores.',
    ),
...
export const transferStudentEnrollmentSchema = z
  .object({
    user_id: z.string().min(1, 'User ID is required.').optional(),
    userId: z.string().min(1, 'User ID is required.').optional(),
...
export const promoteStudentEnrollmentSchema = z
  .object({
    user_id: z.string().min(1, 'User ID is required.').optional(),
    userId: z.string().min(1, 'User ID is required.').optional(),
...
export const exitStudentEnrollmentSchema = z
  .object({
    user_id: z.string().min(1, 'User ID is required.').optional(),
    userId: z.string().min(1, 'User ID is required.').optional(),
    academic_period_id: z.string().min(1, 'Academic period ID is required.').optional(),
...
export const createScheduleSchema = z
  .object({
    ...
    start_time: z
      .string()
      .regex(/^\d{2}:\d{2}(:\d{2})?$/, 'Time format must be HH:mm or HH:mm:ss')
      .optional(),
    startTime: z
      .string()
      .regex(/^\d{2}:\d{2}(:\d{2})?$/, 'Time format must be HH:mm or HH:mm:ss')
